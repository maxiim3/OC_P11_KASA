 ...
 * @type {({txt: string, title: string} | {txt: string, title: string} | {txt: string, title: string} | {txt: string, title: string})[]}
 */
export const ABOUT_PAGE_CONTENT: {title: string; txt: string}[] = [
	{
		title: "Fiabilité",
